...
public interface MemberRepository extends JpaRepository<Member, Long>, MemberRepositoryCustom {
    ...
    List<UsernameOnlyDto> findProjection2ByUsername(@Param("username") String username);

    <T> List<T> findProjection3ByUsername(@Param("username") String username, Class<T> type);
